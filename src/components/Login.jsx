...
export default function Login() {
  ...
  return (
    ...
    <div className='flex justify-center items-center h-screen bg-gradient-to-r from-sky-900 to-sky-700'>
      ...
      <div className='p-5'>
        <img className='rounded-md w-'src='https://media3.giphy.com/media/MFabj1E9mgUsqwVWHu/giphy.gif?cid=ecf05e47m78ogipv1cmt1r5ppx9gph5srzplgcpv03myowf6&ep=v1_gifs_search&rid=giphy.gif&ct=g' />
      </div>
      </div>
    </div>
    </>
