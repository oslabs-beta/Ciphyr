  ...
  return (
    ...
    <div className='flex justify-center items-center h-screen bg-sky-800'>
      ...
      <div className='p-10'>
        ...
        <div className='mt-10'>
        <button onClick={signup} className='bg-sky-800 text-white p-2 w-1/4 rounded-md hover:bg-sky-900'>Sign up</button>
        <button className='bg-white text-sky-800 p-2 w-1/4 border border-sky-800 rounded-md hover:bg-sky-800 hover:text-white'>Login</button>
        </div>
      </div>
      <div className='p-5'>
