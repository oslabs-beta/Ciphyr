    ...
    <nav className='flex flex-col px-10 w-20rem h-screen'>
      ...
      <div className='border-slate-400 mt-10 py-3 flex flex-col items-start'>
        ...
        <details className='mb-5 px-4 py-2 hover:bg-gray-100 hover:font-semibold rounded-md'>
          <summary className='m-1 btn text-slate-700 hover:text-primary list-none cursor-pointer'><FontAwesomeIcon className="mr-2 "icon={faEye} />Suspicious Queries</summary>
          <ul className='absolute p-2 bg-base-100 w-52 mt-4 space-y-8'>
           {queries}
          </ul>
        </details>
        <h1 className='font-lg mb-2 text-slate-900 px-4 py-4 hover:bg-gray-100 hover:text-primary rounded-md w-full'><FontAwesomeIcon icon={faChartLine} /> Insights</h1>
        <h1 className='font-lg mb-2 text-slate-900 px-4 py-4 hover:bg-gray-100 hover:text-primary  rounded-md w-full'><FontAwesomeIcon icon={faFileLines} /> Documentation</h1>
        <h1 className='font-lg mb-2 text-slate-900 px-4 py-4 hover:bg-gray-100 hover:text-primary rounded-md w-full'>More</h1>
      </div>
    </nav>
  );
}
